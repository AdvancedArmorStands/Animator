...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Mo(e,t,n){let r=new Float32Array(vo),i=new K(0,1,0);return new ia({name:`SphericalGaussianBlur`,defines:{n:vo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Fo(),fragmentShader:`
	...
	`}var Io=class extends ln{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Li(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`),l=c.match(/interval:\s*(\d+(?:\.\d+)?)/),u=c.match(/loop:\s*(true|false)/),d=l?Math.max(1,parseInt(l[1],10)):10,f=!u||u[1]===`true`,p=c.match(/realistic-animations:\s*\n\s*enabled:\s*(true|false)\s*\n\s*frames:\s*(\d+)/),m=p?p[1]===`true`:!1,h=p?Math.max(1,parseInt(p[2],10)):1,g=-1;for(let e=0;e<s.length;e+=1)if(/^\s*steps:\s*$/.test(s[e])){g=e;break}if(g<0)return null;let _=[],v=null,y=null;for(let e=g+1;e<s.length;e+=1){let t=s[e];if(!t.trim())continue;let n=t.match(/^\s*-\s*([A-Za-z0-9_]+):\s*$/),r=t.match(/^\s*([A-Za-z0-9_]+):\s*$/),i=t.match(/^\s*([xyz]):\s*(-?\d+(?:\.\d+)?)/);if(n){v=mu(),_.push(v),y=n[1];continue}if(r&&lu.includes(r[1])){y=r[1];continue}if(i&&v&&y&&lu.includes(y)){v[y][i[1]]=parseFloat(i[2]);continue}}return _.length===0?null:{name:i,interval:d,loop:f,realisticEnabled:m,realisticFrames:h,steps:_,allNames:r.map(e=>e.name)}}function Eu({value:e,onChange:t,accent:n,disabled:r,onDragStart:i}){let[a,o]=(0,_.useState)(!1),[s,c]=(0,_.useState)(String(pu(e))),l=(0,_.useRef)(null);(0,_.useEffect)(()=>{a||c(String(pu(e)))},[e,a]);let u=t=>{a||r||(i&&i(),l.current={startX:t.clientX,startVal:e,moved:!1},t.currentTarget.setPointerCapture(t.pointerId))},d=e=>{let n=l.current;if(!n||r)return;let i=e.clientX-n.startX;if(Math.abs(i)>2&&(n.moved=!0),n.moved){let r=e.shiftKey?.1:.5;t(pu(n.startVal+i*r))}},f=()=>{l.current&&!l.current.moved&&!r&&o(!0),l.current=null},p=()=>{let e=parseFloat(s);Number.isNaN(e)||t(pu(e)),o(!1)};return(0,$.jsx)(`div`,{className:`num-field${r?` disabled`:``}`,style:{"--accent":n},onPointerDown:u,onPointerMove:d,onPointerUp:f,children:a?(0,$.jsx)(`input`,{autoFocus:!0,className:`num-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,value:s,onChange:e=>c(e.target.value),onFocus:e=>e.target.select(),onBlur:p,onKeyDown:e=>{e.key===`Enter`&&p(),e.key===`Escape`&&o(!1)}}):(0,$.jsx)(`span`,{className:`num-value`,children:pu(e)})})}var Du=(0,_.forwardRef)(function({initialShowGrid:e,locked:t},n){let r=(0,_.useRef)(t);(0,_.useEffect)(()=>{r.current=t},[t]);let i=(0,_.useRef)(null),a=(0,_.useRef)({});return(0,_.useImperativeHandle)(n,()=>({setPose(e){let t=a.current;!t.joints||!e||lu.forEach(n=>{let r=t.joints[n],i=e[n];r&&i&&r.rotation.set(Vt.degToRad(i.x),Vt.degToRad(i.y),Vt.degToRad(i.z))})},setGridVisible(e){let t=a.current;t.grid&&(t.grid.visible=e)},resetView(){let e=a.current;e.spherical&&(e.spherical.theta=.75,e.spherical.phi=1.15,e.spherical.radius=3.3,e.updateCamera&&e.updateCamera())}})),(0,_.useEffect)(()=>{let t=i.current,n=t.clientWidth||400,o=t.clientHeight||400,s=new Yn;s.background=new Y(1315860),s.fog=new Jn(1315860,6,14);let c=new Ia(42,n/o,.05,100),l=new bl({antialias:!0,alpha:!1});l.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),l.setSize(n,o),l.shadowMap.enabled=!0,l.shadowMap.type=2,t.appendChild(l.domElement);let u=new wa(8952234,1315860,.65);s.add(u);let d=new za(16773856,1.15);d.position.set(2.4,4,2.2),d.castShadow=!0,d.shadow.mapSize.set(1024,1024),d.shadow.camera.left=-2,d.shadow.camera.right=2,d.shadow.camera.top=2,d.shadow.camera.bottom=-2,s.add(d);let f=new za(7315455,.35);f.position.set(-3,2,-2),s.add(f);let p=new no(10,20,3026478,1973790);p.visible=e,s.add(p);let m=new fi(new Hi(4.5,32),new Yi({opacity:.35}));m.rotation.x=-Math.PI/2,m.receiveShadow=!0,s.add(m);let h=new oa({color:14210765,roughness:.85,flatShading:!0}),g=new oa({color:2763567,roughness:.7,flatShading:!0}),_=new oa({color:9071165,roughness:.9,flatShading:!0}),v=new wi({color:0,transparent:!0,opacity:.18});function y(e,t,n,r){let i=new Vi(e,t,n),a=new fi(i,r);return a.castShadow=!0,a.receiveShadow=!0,a.add(new Ii(new qi(i),v)),a}let b=new Bn;s.add(b);let x={},S=y(.8,.07,.8,_);S.position.set(0,.035,0),b.add(S);let C=y(.1,.1,.1,g);C.position.set(0,.12,0),b.add(C);let w=.62,T=y(.14,.06,.14,g);T.position.set(0,w,0),b.add(T),[[`left_leg`,-.11],[`right_leg`,.11]].forEach(([e,t])=>{let n=new Bn;n.position.set(t,w,0);let r=y(.13,.58,.13,h);r.position.set(0,-.29,0),n.add(r);let i=y(.15,.08,.15,g);i.position.set(0,-.58,0),n.add(i),b.add(n),x[e]=n});let E=y(.38,.5199999999999999,.22,h);E.position.set(0,1.7599999999999998/2,0),b.add(E);let D=1.14,O=y(.6,.08,.1,g);O.position.set(0,D,0),b.add(O),[[`left_arm`,-.33],[`right_arm`,.33]].forEach(([e,t])=>{let n=new Bn;n.position.set(t,D,0);let r=y(.12,.56,.12,h);r.position.set(0,-.28,0),n.add(r);let i=y(.14,.09,.14,g);i.position.set(0,-.56,0),n.add(i),b.add(n),x[e]=n});let k=y(.08,.1,.08,g);k.position.set(0,1.23,0),b.add(k);let A=new Bn;A.position.set(0,1.2799999999999998,0);let ee=y(.42,.42,.42,h);ee.position.set(0,.22,0),A.add(ee),b.add(A),x.head=A;let j={theta:.75,phi:1.15,radius:3.3},te=new K(0,.75,0);function ne(){j.phi=Math.max(.35,Math.min(Math.PI-.35,j.phi)),j.radius=Math.max(1.6,Math.min(7,j.radius));let e=te.x+j.radius*Math.sin(j.phi)*Math.sin(j.theta),t=te.y+j.radius*Math.cos(j.phi),n=te.z+j.radius*Math.sin(j.phi)*Math.cos(j.theta);c.position.set(e,t,n),c.lookAt(te)}ne();let M=!1,N=0,P=0,re=l.domElement,ie=e=>{r.current||(M=!0,N=e.clientX,P=e.clientY,re.setPointerCapture(e.pointerId),re.style.cursor=`grabbing`)},ae=e=>{if(!M)return;let t=e.clientX-N,n=e.clientY-P;N=e.clientX,P=e.clientY,j.theta-=t*.006,j.phi-=n*.006,ne()},F=()=>{M=!1,re.style.cursor=`grab`},I=e=>{e.preventDefault(),!r.current&&(j.radius+=e.deltaY*.0018*j.radius,ne())};re.addEventListener(`pointerdown`,ie),re.addEventListener(`pointermove`,ae),re.addEventListener(`pointerup`,F),re.addEventListener(`pointerleave`,F),re.addEventListener(`wheel`,I,{passive:!1}),a.current={scene:s,camera:c,renderer:l,joints:x,spherical:j,updateCamera:ne,grid:p};let L;function R(){L=requestAnimationFrame(R),l.render(s,c)}R();let oe=new ResizeObserver(()=>{n=t.clientWidth,o=t.clientHeight,!(!n||!o)&&(c.aspect=n/o,c.updateProjectionMatrix(),l.setSize(n,o))});return oe.observe(t),()=>{cancelAnimationFrame(L),oe.disconnect(),re.removeEventListener(`pointerdown`,ie),re.removeEventListener(`pointermove`,ae),re.removeEventListener(`pointerup`,F),re.removeEventListener(`pointerleave`,F),re.removeEventListener(`wheel`,I),re.parentNode===t&&t.removeChild(re),l.dispose()}},[]),(0,$.jsx)(`div`,{ref:i,className:`viewport-canvas`})});function Ou({stepIndex:e,steps:t,pose:n,onChangeAxis:r,expanded:i,toggleExpanded:a,lockedParts:o,hiddenParts:s,onDragStart:c,onFlattenAxis:l,onJumpChange:u,onResetAxis:d,onValueContextMenu:f,partOrder:p}){return(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`panel-sub`,children:[`Step `,e+1,` — drag a value to scrub, click to type`]}),(0,$.jsx)(`div`,{className:`parts-list`,children:p.map(p=>{let m=!!o[p],h=!!s[p];return(0,$.jsxs)(`div`,{className:`part-block${h?` is-hidden`:``}`,children:[(0,$.jsxs)(`button`,{type:`button`,className:`part-head`,onClick:()=>a(p),children:[i[p]?(0,$.jsx)(Ml,{size:14}):(0,$.jsx)(Nl,{size:14}),(0,$.jsx)(`span`,{className:`badge-chip`,style:{borderColor:du[p].color,color:du[p].color},children:du[p].badge}),(0,$.jsx)(`span`,{className:`part-label`,children:du[p].label}),m&&(0,$.jsx)(Ul,{size:12,className:`inline-flag`})]}),i[p]&&(0,$.jsx)(`div`,{className:`prop-list`,children:uu.map(i=>{let a=t.some(e=>e[p][i]!==t[0][p][i]),o=n[p][i],s=t.slice(0,e).some(e=>e[p][i]!==o),h=t.slice(e+1).some(e=>e[p][i]!==o);return(0,$.jsxs)(`div`,{className:`prop-row`,onContextMenu:e=>f(e,p,i),children:[(0,$.jsx)(`button`,{type:`button`,className:`stopwatch-btn${a?` on`:``}`,style:{"--accent":du[p].color},disabled:m||!a,onClick:()=>l(p,i),title:a?`Make ${i.toUpperCase()} constant across all steps`:`${i.toUpperCase()} is constant on every step`,children:(0,$.jsx)(iu,{size:12})}),(0,$.jsxs)(`span`,{className:`prop-label`,children:[du[p].label,` `,i.toUpperCase()]}),(0,$.jsx)(`div`,{className:`prop-spacer`}),(0,$.jsx)(Eu,{value:o,accent:du[p].color,disabled:m,onDragStart:c,onChange:e=>r(p,i,e)}),(0,$.jsxs)(`div`,{className:`keyframe-nav`,children:[(0,$.jsx)(`button`,{type:`button`,className:`kf-nav-btn`,disabled:!s,onClick:()=>u(p,i,-1),title:`Previous change`,children:(0,$.jsx)(Pl,{size:13})}),(0,$.jsx)(`button`,{type:`button`,className:`kf-reset-btn`,disabled:m,onClick:()=>d(p,i),title:`Reset this value to 0 on this step`,children:(0,$.jsx)(Zl,{size:12})}),(0,$.jsx)(`button`,{type:`button`,className:`kf-nav-btn`,disabled:!h,onClick:()=>u(p,i,1),title:`Next change`,children:(0,$.jsx)(Nl,{size:13})})]})]},i)})})]},p)})})]})}function ku({animName:e,setAnimName:t,interval:n,setInterval:r,loop:i,setLoop:a,realisticEnabled:o,setRealisticEnabled:s,realisticFrames:c,setRealisticFrames:l,steps:u,onFieldFocus:d}){let f=(Math.max(u.length-1,0)*n*50/1e3).toFixed(2);return(0,$.jsxs)(`div`,{className:`tab-panel`,children:[(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Name`}),(0,$.jsx)(`input`,{className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,value:e,onFocus:d,onChange:e=>t(e.target.value.replace(/\s+/g,`_`))})]}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Interval (ticks)`}),(0,$.jsx)(`input`,{className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,type:`number`,min:`1`,value:n,onFocus:d,onChange:e=>r(Math.max(1,parseInt(e.target.value,10)||1))})]}),(0,$.jsxs)(`label`,{className:`field checkbox-field`,children:[(0,$.jsx)(`span`,{children:`Smooth animation`}),(0,$.jsx)(`button`,{type:`button`,className:`tick-box${o?` on`:``}`,onClick:()=>{d(),s(e=>!e)},children:o&&(0,$.jsx)(jl,{size:12})})]}),o&&(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Interpolation frames`}),(0,$.jsx)(`input`,{className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,type:`number`,min:`1`,value:c,onFocus:d,onChange:e=>l(Math.max(1,parseInt(e.target.value,10)||1))})]}),(0,$.jsxs)(`label`,{className:`field checkbox-field`,children:[(0,$.jsx)(`span`,{children:`Loop`}),(0,$.jsx)(`button`,{type:`button`,className:`tick-box${i?` on`:``}`,onClick:()=>{d(),a(e=>!e)},children:i&&(0,$.jsx)(jl,{size:12})})]}),(0,$.jsxs)(`div`,{className:`stat-row`,children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`span`,{className:`stat-num`,children:u.length}),(0,$.jsx)(`span`,{className:`stat-label`,children:`steps`})]}),(0,$.jsxs)(`div`,{children:[(0,$.jsxs)(`span`,{className:`stat-num`,children:[f,`s`]}),(0,$.jsx)(`span`,{className:`stat-label`,children:`duration`})]})]})]})}function Au({animName:e,interval:t,loop:n,realisticEnabled:r,realisticFrames:i,steps:a,fullYaml:o,copySnippet:s,downloadYaml:c,copyStatus:l,downloadStatus:u,onSaveBrowser:d,saveBrowserStatus:f}){let p=(Math.max(a.length-1,0)*t*50/1e3).toFixed(2);return(0,$.jsxs)(`div`,{className:`export-workspace`,children:[(0,$.jsxs)(`div`,{className:`export-side`,children:[(0,$.jsx)(`div`,{className:`export-side-header`,children:`Export Summary`}),(0,$.jsxs)(`div`,{className:`export-summary`,children:[(0,$.jsxs)(`div`,{className:`summary-row`,children:[(0,$.jsx)(`span`,{children:`Name`}),(0,$.jsx)(`b`,{children:e||`unnamed`})]}),(0,$.jsxs)(`div`,{className:`summary-row`,children:[(0,$.jsx)(`span`,{children:`Interval`}),(0,$.jsxs)(`b`,{children:[t,` ticks`]})]}),(0,$.jsxs)(`div`,{className:`summary-row`,children:[(0,$.jsx)(`span`,{children:`Loop`}),(0,$.jsx)(`b`,{children:n?`Yes`:`No`})]}),(0,$.jsxs)(`div`,{className:`summary-row`,children:[(0,$.jsx)(`span`,{children:`Smooth animation`}),(0,$.jsx)(`b`,{children:r?`On · ${i}f`:`Off`})]}),(0,$.jsxs)(`div`,{className:`summary-row`,children:[(0,$.jsx)(`span`,{children:`Steps`}),(0,$.jsx)(`b`,{children:a.length})]}),(0,$.jsxs)(`div`,{className:`summary-row`,children:[(0,$.jsx)(`span`,{children:`Duration`}),(0,$.jsxs)(`b`,{children:[p,`s`]})]})]}),(0,$.jsxs)(`button`,{type:`button`,className:`export-btn`,onClick:s,children:[(0,$.jsx)(Il,{size:15}),` Copy animation block`]}),(0,$.jsxs)(`div`,{className:`hint`,children:[`Paste this under the `,(0,$.jsx)(`code`,{children:`animations:`}),` key in your existing `,(0,$.jsx)(`code`,{children:`animations.yml`}),`.`]}),l&&(0,$.jsx)(`div`,{className:`status-msg`,children:l}),(0,$.jsxs)(`button`,{type:`button`,className:`export-btn primary`,onClick:c,style:{marginTop:14},children:[(0,$.jsx)(Rl,{size:15}),` Download animations.yml`]}),(0,$.jsx)(`div`,{className:`hint`,children:`Full file — drop it straight into the plugin's config folder.`}),u&&(0,$.jsx)(`div`,{className:`status-msg`,children:u}),(0,$.jsxs)(`button`,{type:`button`,className:`export-btn`,onClick:d,style:{marginTop:14},children:[(0,$.jsx)(Ql,{size:15}),` Save to browser`]}),(0,$.jsx)(`div`,{className:`hint`,children:`Keeps a copy in this browser so you can pick up where you left off from the Import screen.`}),f&&(0,$.jsx)(`div`,{className:`status-msg`,children:f})]}),(0,$.jsxs)(`div`,{className:`export-preview`,children:[(0,$.jsx)(`div`,{className:`export-preview-header`,children:`animations.yml`}),(0,$.jsx)(`textarea`,{className:`yaml-preview export-yaml`,readOnly:!0,value:o,spellCheck:!1})]})]})}var ju=38;function Mu({steps:e,selectedStep:t,setSelectedStep:n,interval:r,addStep:i,duplicateStep:a,deleteStep:o,zoom:s,setZoom:c,playheadRef:l,lockedParts:u,hiddenParts:d,toggleLocked:f,toggleHidden:p,onDotContextMenu:m,onTimelineContextMenu:h,selectedDots:g,setSelectedDots:v,isPlaying:y,onMoveStep:b,scrollAreaRef:x,partOrder:S,setPartOrder:C}){let w=(0,_.useRef)(null),T=e=>{w.current=e},E=(e,t)=>{e.preventDefault(),!(!w.current||w.current===t)&&C(e=>{let n=e.indexOf(w.current),r=e.indexOf(t);if(n===-1||r===-1||n===r)return e;let i=[...e];return i.splice(n,1),i.splice(r,0,w.current),i})},D=()=>{w.current=null},O=(0,_.useRef)(null),k=64*s,A=Math.max(e.length*k+60,360),ee=(0,_.useRef)(null),j=(0,_.useRef)(null),te=(0,_.useRef)(null),[ne,M]=(0,_.useState)(null),[N,P]=(0,_.useState)(!1),re=t=>{let n=t-ee.current.getBoundingClientRect().left;return Math.max(0,Math.min(e.length-1,Math.round(n/k)))},ie=e=>{e.target.closest(`.keyframe-dot`)||h(e,re(e.clientX))},ae=(e,t,n)=>{O.current={part:t,fromIdx:n,startX:e.clientX,moved:!1},e.currentTarget.setPointerCapture(e.pointerId)},F=e=>{let t=O.current;t&&Math.abs(e.clientX-t.startX)>4&&(t.moved=!0)},I=(e,t,r)=>{let i=O.current;if(O.current=null,!i)return;if(!i.moved){v(new Set),n(r);return}let a=re(e.clientX);a!==i.fromIdx&&b(i.fromIdx,a,e.altKey)},L=(0,_.useRef)(!1),R=e=>{L.current=!0,e.currentTarget.setPointerCapture(e.pointerId),n(re(e.clientX))},oe=e=>{L.current&&n(re(e.clientX))},se=()=>{L.current=!1},ce=t=>{let r=ee.current.getBoundingClientRect(),i=t.clientX-r.left,a=Math.max(0,Math.min(e.length-1,Math.round(i/k)));v(new Set),n(a)},le=e=>{if(e.target.closest(`.keyframe-dot`)||e.button!==void 0&&e.button!==0)return;e.preventDefault();let t=j.current.getBoundingClientRect(),n=e.clientX-t.left,r=e.clientY-t.top;if(te.current={startX:n,startY:r,rectSnapshot:t},P(!1),M({left:n,top:r,width:0,height:0}),e.currentTarget.setPointerCapture)try{e.currentTarget.setPointerCapture(e.pointerId)}catch{}},ue=t=>{if(!(t.width>3||t.height>3))return new Set;let n=new Set;return lu.forEach((r,i)=>{let a=i*ju;a+ju<t.top||a>t.top+t.height||e.forEach((e,i)=>{let a=i*k+k/2;a>=t.left&&a<=t.left+t.width&&n.add(`${r}-${i}`)})}),n},de=e=>{if(!te.current)return;let t=te.current.rectSnapshot,n=t.width,r=t.height,i=Math.max(0,Math.min(n,e.clientX-t.left)),a=Math.max(0,Math.min(r,e.clientY-t.top)),o=Math.min(te.current.startX,i),s=Math.min(te.current.startY,a),c=Math.abs(i-te.current.startX),l=Math.abs(a-te.current.startY);M({left:o,top:s,width:c,height:l}),v(ue({left:o,top:s,width:c,height:l}))},fe=()=>{te.current&&(te.current=null,M(e=>(e&&v(ue(e)),e)),P(!0),setTimeout(()=>{M(null),P(!1)},300))},pe=(0,_.useRef)(fe);return pe.current=fe,(0,_.useEffect)(()=>{let e=()=>{te.current&&pe.current()};return window.addEventListener(`pointerup`,e),window.addEventListener(`pointercancel`,e),window.addEventListener(`blur`,e),()=>{window.removeEventListener(`pointerup`,e),window.removeEventListener(`pointercancel`,e),window.removeEventListener(`blur`,e)}},[]),(0,$.jsxs)(`div`,{className:`timeline-main`,children:[(0,$.jsxs)(`div`,{className:`tool-strip`,children:[(0,$.jsx)(`button`,{type:`button`,className:`tool-btn active`,title:`Selection tool`,children:(0,$.jsx)(Kl,{size:16})}),(0,$.jsx)(`div`,{className:`tool-sep`}),(0,$.jsx)(`button`,{type:`button`,className:`tool-btn`,onClick:i,title:`Add step`,children:(0,$.jsx)(Yl,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:`tool-btn`,onClick:()=>a(t),title:`Duplicate step`,children:(0,$.jsx)(Il,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:`tool-btn`,onClick:()=>o(t),disabled:e.length<=1,title:`Delete step`,children:(0,$.jsx)(au,{size:16})}),(0,$.jsx)(`div`,{className:`tool-sep`}),(0,$.jsx)(`button`,{type:`button`,className:`tool-btn`,onClick:()=>c(e=>Math.min(2.5,pu(e+.2))),title:`Zoom in`,children:(0,$.jsx)(ou,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:`tool-btn`,onClick:()=>c(e=>Math.max(.5,pu(e-.2))),title:`Zoom out`,children:(0,$.jsx)(su,{size:16})})]}),(0,$.jsxs)(`div`,{className:`timeline-tracks-header`,children:[(0,$.jsx)(`div`,{className:`track-header-spacer`}),S.map(e=>{let t=!!u[e],n=!!d[e];return(0,$.jsxs)(`div`,{className:`track-header-row${n?` is-hidden`:``}`,draggable:!0,onDragStart:()=>T(e),onDragOver:t=>E(t,e),onDragEnd:D,title:`Drag to reorder this track`,children:[(0,$.jsx)(`button`,{type:`button`,className:`mini-icon-btn`,onClick:()=>f(e),title:t?`Unlock track`:`Lock track`,children:t?(0,$.jsx)(Ul,{size:12}):(0,$.jsx)(Hl,{size:12})}),(0,$.jsx)(`button`,{type:`button`,className:`mini-icon-btn`,onClick:()=>p(e),title:n?`Show in preview`:`Hide from preview`,children:n?(0,$.jsx)(zl,{size:12}):(0,$.jsx)(Bl,{size:12})}),(0,$.jsx)(`span`,{className:`badge-chip`,style:{borderColor:du[e].color,color:du[e].color},children:du[e].badge}),(0,$.jsx)(`span`,{className:`track-name`,children:du[e].label})]},e)})]}),(0,$.jsx)(`div`,{className:`timeline-scroll`,ref:x,children:(0,$.jsxs)(`div`,{className:`timeline-body`,ref:ee,style:{minWidth:A},children:[(0,$.jsx)(`div`,{className:`ruler`,onClick:ce,onContextMenu:ie,children:e.map((e,t)=>(0,$.jsx)(`div`,{className:`ruler-tick`,style:{left:t*k},children:(0,$.jsxs)(`span`,{children:[t*r,`t`]})},t))}),(0,$.jsxs)(`div`,{className:`tracks-area`,ref:j,onPointerDown:le,onPointerMove:de,onPointerUp:fe,onContextMenu:ie,children:[S.map(n=>{let r=!!d[n];return(0,$.jsx)(`div`,{className:`track-row${r?` is-hidden`:``}`,children:e.map((e,r)=>(0,$.jsx)(`button`,{type:`button`,className:`keyframe-dot${r===t?` active`:``}${g.has(`${n}-${r}`)?` marquee-selected`:``}`,style:{left:r*k+k/2-6,background:du[n].color},onPointerDown:e=>ae(e,n,r),onPointerMove:F,onPointerUp:e=>I(e,n,r),onContextMenu:e=>m(e,n,r),title:`${du[n].label} — step ${r+1} (drag to move, alt-drag to copy)`},r))},n)}),ne&&(0,$.jsx)(`div`,{className:`marquee-box${N?` fading`:``}`,style:{left:ne.left,top:ne.top,width:ne.width,height:ne.height}})]}),(0,$.jsxs)(`div`,{className:`playhead-wrap`,ref:l,style:{left:t*k+k/2},children:[(0,$.jsx)(`div`,{className:`playhead-handle`,onPointerDown:R,onPointerMove:oe,onPointerUp:se,title:`Drag to scrub`}),(0,$.jsx)(`div`,{className:`playhead-line`})]})]})})]})}function Nu({menus:e,openMenu:t,setOpenMenu:n,onAction:r,flags:i}){return(0,$.jsx)(`div`,{className:`menu-bar`,children:Object.keys(e).map(a=>(0,$.jsxs)(`div`,{className:`menu-wrap`,children:[(0,$.jsx)(`div`,{className:`menu-item${t===a?` open`:``}`,onClick:()=>n(e=>e===a?null:a),children:a}),t===a&&(0,$.jsx)(`div`,{className:`menu-dropdown`,children:e[a].map((e,t)=>e.divider?(0,$.jsx)(`div`,{className:`menu-divider`},`d${t}`):(0,$.jsxs)(`button`,{type:`button`,className:`menu-dd-item`,disabled:e.disabledKey?!i[e.disabledKey]:!1,onClick:()=>{r(e.action),n(null)},children:[(0,$.jsx)(`span`,{children:e.label}),e.shortcut&&(0,$.jsx)(`span`,{className:`menu-shortcut`,children:e.shortcut})]},e.action))})]},a))})}function Pu({modal:e,onClose:t,savePref:n}){let[r,i]=(0,_.useState)(``),[a,o]=(0,_.useState)(``),[s,c]=(0,_.useState)(``),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(!1),[p,m]=(0,_.useState)(``);(0,_.useEffect)(()=>{e&&(i(e.initial??``),o(``),c(``),m(``),u(!1))},[e]);let h=wu(a);if((0,_.useEffect)(()=>{h.length&&!h.includes(p)&&m(h[0])},[a]),!e)return null;let g=()=>{if(e.kind===`prompt`)e.onSubmit(r),t();else if(e.kind===`confirm`)e.onConfirm(l),t();else if(e.kind===`import`){let n=Tu(a,p);if(!n){c(`Couldn't find a valid animation in that text — needs a name, interval, loop and steps.`);return}e.onImport(n),t()}else t()};return(0,$.jsx)(`div`,{className:`modal-overlay`,onClick:t,children:(0,$.jsxs)(`div`,{className:`modal-box${e.kind===`import`?` wide`:``}`,onClick:e=>e.stopPropagation(),children:[(0,$.jsx)(`div`,{className:`modal-title`,children:e.title}),e.kind===`prompt`&&(0,$.jsx)(`input`,{autoFocus:!0,className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,value:r,onChange:e=>i(e.target.value),onKeyDown:e=>{e.key===`Enter`&&g()}}),e.kind===`save`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsx)(`div`,{className:`modal-body`,style:{textAlign:`left`},children:e.message}),(0,$.jsxs)(`button`,{type:`button`,className:`modal-big-btn${e.selectMode&&n===`export`?` selected`:``}`,onClick:()=>{e.onExport(l),e.selectMode||t()},children:[(0,$.jsx)(Rl,{size:20}),`Export file`,e.selectMode&&n===`export`&&(0,$.jsx)(jl,{size:16,className:`modal-big-btn-check`})]}),(0,$.jsxs)(`button`,{type:`button`,className:`modal-big-btn${e.selectMode&&n===`browser`?` selected`:``}`,onClick:()=>{e.onSaveBrowser(l),e.selectMode||t()},children:[(0,$.jsx)(Ql,{size:20}),`Save to browser`,e.selectMode&&n===`browser`&&(0,$.jsx)(jl,{size:16,className:`modal-big-btn-check`})]})]}),e.kind===`confirm`&&(0,$.jsx)(`div`,{className:`modal-body`,children:e.message}),(e.kind===`confirm`||e.kind===`save`)&&e.showCheckbox&&!e.selectMode&&(0,$.jsxs)(`label`,{className:`field checkbox-field`,children:[(0,$.jsxs)(`span`,{children:[e.checkboxLabel,(0,$.jsxs)(`span`,{className:`help-icon-wrap`,children:[(0,$.jsx)(`button`,{type:`button`,className:`help-icon-btn`,onClick:()=>f(e=>!e),onMouseEnter:()=>f(!0),onMouseLeave:()=>f(!1),children:(0,$.jsx)(Fl,{size:13})}),d&&(0,$.jsx)(`div`,{className:`help-tooltip`,children:`Checking this remembers whichever button you click (Export file or Save to browser) and does that same one automatically every time you hit Ctrl/⌘ S, no popup. Undo it anytime from File → Reset save preference.`})]})]}),(0,$.jsx)(`button`,{type:`button`,className:`tick-box${l?` on`:``}`,onClick:()=>u(e=>!e),children:l&&(0,$.jsx)(jl,{size:12})})]}),e.kind===`info`&&(0,$.jsx)(`div`,{className:`modal-body`,children:e.body}),e.kind===`import`&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`modal-body`,children:[`Paste your `,(0,$.jsx)(`code`,{children:`animations.yml`}),` (or just one animation block) below.`]}),(0,$.jsx)(`textarea`,{autoFocus:!0,className:`yaml-preview`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,style:{minHeight:200},value:a,onChange:e=>{o(e.target.value),c(``)},placeholder:`wave:
  ...
  steps:
    - head:
        x: 0
        ...`}),h.length>1&&(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsxs)(`span`,{children:[`Found `,h.length,` animations — import which one?`]}),(0,$.jsx)(`select`,{className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,value:p,onChange:e=>m(e.target.value),children:h.map(e=>(0,$.jsx)(`option`,{value:e,children:e},e))})]}),s&&(0,$.jsx)(`div`,{className:`modal-error`,children:s})]}),(0,$.jsxs)(`div`,{className:`modal-actions`,children:[e.kind!==`info`&&e.kind!==`save`&&(0,$.jsx)(`button`,{type:`button`,className:`export-btn`,onClick:t,children:`Cancel`}),e.kind!==`info`&&e.kind!==`save`&&(0,$.jsx)(`button`,{type:`button`,className:`export-btn primary`,onClick:g,children:e.confirmLabel||`OK`}),(e.kind===`info`||e.kind===`save`)&&(0,$.jsx)(`button`,{type:`button`,className:`export-btn primary`,onClick:t,children:`Close`})]})]})})}function Fu({menu:e,onClose:t}){let n=(0,_.useRef)(null);if((0,_.useEffect)(()=>{if(!e)return;let r=e=>{n.current&&!n.current.contains(e.target)&&t()},i=e=>{e.key===`Escape`&&t()};return window.addEventListener(`pointerdown`,r),window.addEventListener(`contextmenu`,r),window.addEventListener(`keydown`,i),()=>{window.removeEventListener(`pointerdown`,r),window.removeEventListener(`contextmenu`,r),window.removeEventListener(`keydown`,i)}},[e,t]),!e)return null;let r=e.items.length*30+12,i=Math.max(6,Math.min(e.x,window.innerWidth-220-6)),a=Math.max(6,Math.min(e.y,window.innerHeight-r-6));return(0,$.jsx)(`div`,{className:`context-menu`,ref:n,style:{left:i,top:a},children:e.items.map((e,n)=>e.divider?(0,$.jsx)(`div`,{className:`menu-divider`},`d${n}`):e.header?(0,$.jsx)(`div`,{className:`context-menu-header`,children:e.label},`h${n}`):(0,$.jsxs)(`button`,{type:`button`,className:`menu-dd-item${e.danger?` danger`:``}`,disabled:!!e.disabled,onClick:()=>{e.action(),t()},children:[(0,$.jsx)(`span`,{children:e.label}),e.shortcut&&(0,$.jsx)(`span`,{className:`menu-shortcut`,children:e.shortcut})]},e.label))})}var Iu=`
...
`;function Lu({zoneId:e,panelIds:t,activeId:n,onActivate:r,onDragStartTab:i,onDragOverZone:a,onDragLeaveZone:o,onDropTab:s,onDragEndTab:c,isDropTarget:l,isDraggingAnything:u,renderContent:d,horizontal:f}){return t.length===0?u?(0,$.jsx)(`div`,{className:`dock-empty-strip${f?` horizontal`:``}${l?` drop-target`:``}`,onDragOver:t=>{t.preventDefault(),a(e)},onDragLeave:()=>o(e),onDrop:t=>{t.preventDefault(),s(e)},children:(0,$.jsx)(`span`,{children:`Drop panel here`})}):null:(0,$.jsxs)(`div`,{className:`panel dock-panel${f?` horizontal`:``}${l?` drop-target`:``}`,children:[(0,$.jsxs)(`div`,{className:`tab-strip`,onDragOver:t=>{t.preventDefault(),a(e)},onDragLeave:()=>o(e),onDrop:t=>{t.preventDefault(),s(e)},children:[t.map(t=>(0,$.jsx)(`div`,{className:`tab${t===n?` active`:``}`,draggable:!0,onDragStart:n=>{n.dataTransfer.effectAllowed=`move`,i(t,e)},onDragEnd:c,onClick:()=>r(e,t),title:`Drag to move this panel`,children:gu[t].title},t)),l&&(0,$.jsx)(`div`,{className:`dock-drop-hint`})]}),d(n)]})}function Ru(){let[e,t]=(0,_.useState)(!1);(0,_.useEffect)(()=>{let e=document.createElement(`link`);e.rel=`stylesheet`,e.href=`https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap`;let n=()=>t(!0);e.onload=n,e.onerror=n,document.head.appendChild(e);let r=setTimeout(n,1400);return()=>{document.head.removeChild(e),clearTimeout(r)}},[]);let[n,r]=(0,_.useState)(`unnamed`),[i,a]=(0,_.useState)(10),[o,s]=(0,_.useState)(!0),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(4),[f,p]=(0,_.useState)([mu()]),[m,h]=(0,_.useState)(0),[g,v]=(0,_.useState)({head:!0,left_arm:!0,right_arm:!0,left_leg:!1,right_leg:!1}),[y,b]=(0,_.useState)({}),[x,S]=(0,_.useState)(()=>{try{let e=localStorage.getItem(`aas-part-order`),t=e?JSON.parse(e):null;if(Array.isArray(t)&&t.length===lu.length&&lu.every(e=>t.includes(e)))return t}catch{}return[...lu]});(0,_.useEffect)(()=>{let e=setTimeout(()=>{try{localStorage.setItem(`aas-part-order`,JSON.stringify(x))}catch{}},300);return()=>clearTimeout(e)},[x]);let[C,w]=(0,_.useState)({}),[T,E]=(0,_.useState)(()=>new Set),[D,O]=(0,_.useState)(!1),[k,A]=(0,_.useState)(1),[ee,j]=(0,_.useState)(``),[te,ne]=(0,_.useState)(``),[M,N]=(0,_.useState)(!0),[P,re]=(0,_.useState)(!0),[ie,ae]=(0,_.useState)(_u),[F,I]=(0,_.useState)(vu),[L,R]=(0,_.useState)(null),[oe,se]=(0,_.useState)(null),[ce,le]=(0,_.useState)(!1),[ue,de]=(0,_.useState)(!1),[fe,pe]=(0,_.useState)(!1),[me,he]=(0,_.useState)(360),[ge,_e]=(0,_.useState)(`animate`),[ve,ye]=(0,_.useState)(null),[be,xe]=(0,_.useState)(null),[Se,Ce]=(0,_.useState)(!1),[we,Te]=(0,_.useState)(null),[Ee,De]=(0,_.useState)(null),[Oe,ke]=(0,_.useState)(null);function z(){return JSON.stringify({animName:n,interval:i,loop:o,realisticEnabled:c,realisticFrames:u,steps:f})}let[Ae,je]=(0,_.useState)(``);function Me(){try{let e=localStorage.getItem(`aas-saved-project`);De(e?JSON.parse(e):null)}catch{De(null)}}function B(){try{let e=JSON.stringify({animName:n,interval:i,loop:o,realisticEnabled:c,realisticFrames:u,steps:f,savedAt:Date.now()});localStorage.setItem(`aas-saved-project`,e),ke(z()),je(`Saved to browser`)}catch{je(`Not available in this browser`)}setTimeout(()=>je(``),2500)}function Ne(){Ee&&(r(Ee.animName),a(Ee.interval),s(Ee.loop),l(!!Ee.realisticEnabled),d(Ee.realisticFrames||1),p(Ee.steps),h(0),ot([]),ct([]),ae(_u),I(vu),_e(`animate`),Ce(!0))}function V(){try{localStorage.removeItem(`aas-saved-project`)}catch{}De(null)}let[H,Pe]=(0,_.useState)(`choice`),[Fe,Ie]=(0,_.useState)(``),[Le,Re]=(0,_.useState)(10),[ze,Be]=(0,_.useState)(!0),[Ve,He]=(0,_.useState)(!1),[Ue,We]=(0,_.useState)(4),[Ge,Ke]=(0,_.useState)(``),[qe,Je]=(0,_.useState)(``),[Ye,Xe]=(0,_.useState)(``),[Ze,Qe]=(0,_.useState)(!1),[$e,et]=(0,_.useState)(``),[tt,nt]=(0,_.useState)(0),[rt,it]=(0,_.useState)([]),[at,ot]=(0,_.useState)([]),[st,ct]=(0,_.useState)([]),[lt,ut]=(0,_.useState)(null),[dt,U]=(0,_.useState)(null),[W,ft]=(0,_.useState)(null),[pt,mt]=(0,_.useState)(()=>typeof window>`u`?{w:1200,h:800}:{w:window.innerWidth,h:window.innerHeight});(0,_.useEffect)(()=>{let e=()=>mt({w:window.innerWidth,h:window.innerHeight});return window.addEventListener(`resize`,e),window.addEventListener(`orientationchange`,e),()=>{window.removeEventListener(`resize`,e),window.removeEventListener(`orientationchange`,e)}},[]);let ht=typeof navigator<`u`&&/iPhone|iPod|Android.*Mobile|Windows Phone|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||pt.w<620&&typeof window<`u`&&`ontouchstart`in window,gt=!ht&&(pt.w<980||pt.h<560),_t=(0,_.useRef)(null),vt=(0,_.useRef)(null);(0,_.useEffect)(()=>{if(!Se)return;let e=e=>{e.preventDefault(),e.returnValue=`Reloading will lose everything in this project — are you sure?`};return window.addEventListener(`beforeunload`,e),()=>window.removeEventListener(`beforeunload`,e)},[Se]),(0,_.useEffect)(()=>{_t.current&&_t.current.setGridVisible(ce)},[ce]);let yt=(0,_.useRef)(null),bt=(0,_.useRef)(null),G=(0,_.useRef)(f);(0,_.useEffect)(()=>{G.current=f},[f]);let xt=(0,_.useRef)(i);(0,_.useEffect)(()=>{xt.current=i},[i]);let St=(0,_.useRef)(o);(0,_.useEffect)(()=>{St.current=o},[o]);let Ct=(0,_.useRef)(C);(0,_.useEffect)(()=>{Ct.current=C},[C]);let wt=(0,_.useRef)(n);(0,_.useEffect)(()=>{wt.current=n},[n]);let Tt=(0,_.useRef)(m);(0,_.useEffect)(()=>{Tt.current=m},[m]);let Et=(0,_.useRef)(D);(0,_.useEffect)(()=>{Et.current=D},[D]);let Dt=(0,_.useRef)(m);(0,_.useEffect)(()=>{Et.current||(Dt.current=m)},[m]);let Ot=64*k,kt=(0,_.useRef)(null),At=(0,_.useRef)(null),jt=(0,_.useRef)(null),Mt=e=>{let t=vt.current;t&&(e<t.scrollLeft||e>t.scrollLeft+t.clientWidth)&&(t.scrollLeft=Math.max(0,e-20))},Nt=e=>{let t=G.current.length,n=t>1?Math.min(1,Math.max(0,e/(t-1))):0;if(kt.current&&(kt.current.style.width=`${n*100}%`),At.current&&(At.current.style.left=`${n*100}%`),jt.current){let t=e*Math.max(xt.current,1)*50;jt.current.textContent=Su(t)}};(0,_.useEffect)(()=>{if(D)return;let e=xu(f,Dt.current);e&&_t.current&&_t.current.setPose(bu(e,C)),Nt(Dt.current),Mt(Dt.current*Ot+Ot/2)},[f,m,D,C]),(0,_.useEffect)(()=>{if(!D){cancelAnimationFrame(bt.current);return}let e=Dt.current,t=null,n=Math.floor(e);function r(i){let a=G.current.length;if(t===null||a<2){t=i,bt.current=requestAnimationFrame(r);return}let o=Math.max(xt.current,1)*50,s=Math.min(i-t,250);if(t=i,e+=s/o,!St.current&&e>=a-1){let e=a-1;Dt.current=e,_t.current&&_t.current.setPose(bu(G.current[e],Ct.current)),yt.current&&(yt.current.style.left=`${e*Ot+Ot/2}px`),Mt(e*Ot+Ot/2),Nt(e),h(e),O(!1);return}let c=St.current?(e%a+a)%a:e;e=c;let l=Math.min(a-1,Math.floor(c)),u=c-l,d=(l+1)%a;Dt.current=c;let f=bu(yu(G.current[l],G.current[d],u),Ct.current);_t.current&&_t.current.setPose(f);let p=c*Ot+Ot/2;yt.current&&(yt.current.style.left=`${p}px`),Mt(p),Nt(c),l!==n&&(n=l,h(l)),bt.current=requestAnimationFrame(r)}return bt.current=requestAnimationFrame(r),()=>cancelAnimationFrame(bt.current)},[D]);function Pt(){let e={steps:hu(G.current),animName:wt.current,interval:xt.current,loop:St.current,realisticEnabled:c,realisticFrames:u};ot(t=>[...t.slice(-49),e]),ct([])}function Ft(e){p(e.steps),r(e.animName),a(e.interval),s(e.loop),e.realisticEnabled!==void 0&&l(e.realisticEnabled),e.realisticFrames!==void 0&&d(e.realisticFrames),h(t=>Math.min(t,e.steps.length-1))}function It(){if(we===`export`){yn();return}if(we===`browser`){B();return}xe({kind:`save`,title:`Save your work?`,message:`This tool can't save automatically, you can do one of these:`,showCheckbox:!0,checkboxLabel:`Do one of these every time instead of asking`,onExport:e=>{e&&Te(`export`),yn()},onSaveBrowser:e=>{e&&Te(`browser`),B()}})}function Lt(){Re(10),Be(!0),He(!1),We(4)}function Rt(){let e=Fe.trim().replace(/\s+/g,`_`)||`unnamed`;r(e),a(Le),s(ze),l(Ve),d(Ue),p([mu()]),h(0),ot([]),ct([]),ae(_u),I(vu),_e(`animate`),Ce(!0)}let zt=wu(Ge);(0,_.useEffect)(()=>{H===`import`&&Me()},[H]);function Bt(){let e=Tu(Ge,qe);if(!e){Xe(`Couldn't find a valid animation in that text — needs a name, interval, loop and steps.`);return}r(e.name),a(e.interval),s(e.loop),l(e.realisticEnabled),d(e.realisticFrames),p(e.steps),h(0),ot([]),ct([]),ae(_u),I(vu),_e(`animate`),_e(`animate`),Ce(!0)}function Vt(){if(at.length===0)return;let e=at[at.length-1];ot(at.slice(0,-1)),ct(e=>[...e,{steps:hu(G.current),animName:wt.current,interval:xt.current,loop:St.current}]),Ft(e)}function Ht(){if(st.length===0)return;let e=st[st.length-1];ct(st.slice(0,-1)),ot(e=>[...e,{steps:hu(G.current),animName:wt.current,interval:xt.current,loop:St.current}]),Ft(e)}let Ut=()=>O(e=>{let t=!e;return t&&!St.current&&Dt.current>=G.current.length-1&&(Dt.current=0,h(0)),t}),K=()=>{O(!1),h(0)},Wt=()=>{O(!1),h(f.length-1)},Gt=()=>{O(!1),h(e=>Math.max(0,e-1))},q=()=>{O(!1),h(e=>Math.min(f.length-1,e+1))},Kt=()=>{Pt(),s(e=>!e)},qt=(e,t)=>{Pt(),p(n=>{let r=t??n[e]??n[n.length-1],i=JSON.parse(JSON.stringify(r));return[...n.slice(0,e+1),i,...n.slice(e+1)]}),h(e+1)},Jt=()=>qt(Tt.current),Yt=e=>{Pt(),p(t=>{let n=JSON.parse(JSON.stringify(t[e]));return[...t.slice(0,e+1),n,...t.slice(e+1)]}),h(e+1)},J=e=>{G.current.length<=1||(Pt(),p(t=>t.filter((t,n)=>n!==e)),h(Math.max(0,e-1)))},Xt=e=>{Pt(),p(t=>t.map((t,n)=>n===e?mu():t))},Zt=()=>Xt(Tt.current),Qt=(e,t,n)=>{Pt(),p(r=>{let i=[...r];if(n){let n=hu([r[e]])[0],a=Math.max(0,Math.min(i.length,t));i.splice(a,0,n)}else{let[n]=i.splice(e,1),r=Math.max(0,Math.min(i.length,t));i.splice(r,0,n)}return i}),h(Math.max(0,Math.min(t,n?G.current.length:G.current.length-1)))},$t=()=>{if(T.size===0){J(Tt.current);return}let e={};T.forEach(t=>{let n=t.lastIndexOf(`-`),r=t.slice(0,n),i=parseInt(t.slice(n+1),10);e[i]||(e[i]=new Set),e[i].add(r)});let t=[],n=[];Object.keys(e).forEach(r=>{let i=parseInt(r,10),a=e[i];a.size>=lu.length?t.push(i):a.forEach(e=>n.push({idx:i,part:e}))});let r=G.current.length,i=t.length>0?Math.max(1,r-t.length):r;Pt(),p(e=>{let r=e.map((e,t)=>{let r=n.filter(e=>e.idx===t);if(r.length===0)return e;let i={...e};return r.forEach(({part:e})=>{i[e]={x:0,y:0,z:0}}),i});if(t.length>0){let e=new Set(t),n=r.filter((t,n)=>!e.has(n));r=n.length>0?n:r}return r}),E(new Set),h(e=>Math.max(0,Math.min(e,i-1)))},en=(e,t,n)=>{if(y[e])return;let r=Math.max(-180,Math.min(180,n));p(n=>n.map((n,i)=>i===Tt.current?{...n,[e]:{...n[e],[t]:r}}:n))},tn=e=>v(t=>({...t,[e]:!t[e]})),nn=()=>ut(null),rn=(e,t,n)=>ut({x:e,y:t,items:n}),an=(e,t,n)=>{e.preventDefault(),e.stopPropagation(),rn(e.clientX,e.clientY,[{header:!0,label:`Step ${n+1} · ${du[t].label}`},{divider:!0},{label:`Select step`,action:()=>{O(!1),h(n)}},{label:`Copy step pose`,action:()=>U(hu([G.current[n]])[0])},{label:`Paste pose here`,disabled:!dt,action:()=>{Pt(),p(e=>e.map((e,t)=>t===n?hu([dt])[0]:e))}},{divider:!0},{label:`Duplicate step`,shortcut:`Ctrl/⌘ D`,action:()=>Yt(n)},{label:`Reset this step's pose`,action:()=>Xt(n)},{label:`Delete step`,shortcut:`Del`,disabled:G.current.length<=1,danger:!0,action:()=>J(n)}])},on=(e,t)=>{e.preventDefault(),e.stopPropagation(),rn(e.clientX,e.clientY,[{header:!0,label:`Tick ${t*xt.current}`},{divider:!0},{label:`Add step here`,action:()=>qt(t)},{label:`Paste pose as new step`,disabled:!dt,action:()=>qt(t,dt)}])},sn=(e,t,n)=>{e.preventDefault(),e.stopPropagation();let r=G.current[Tt.current][t][n];rn(e.clientX,e.clientY,[{header:!0,label:`${du[t].label} ${n.toUpperCase()}`},{divider:!0},{label:`Copy value`,action:()=>ft(r)},{label:`Paste value`,disabled:W===null,action:()=>{Pt(),en(t,n,W)}},{label:`Reset to 0`,action:()=>pn(t,n)},{label:`Make constant across all steps`,action:()=>mn(t,n)}])},cn=e=>{e.preventDefault(),e.stopPropagation(),rn(e.clientX,e.clientY,[{label:`Reset camera`,action:()=>_t.current&&_t.current.resetView()},{label:D?`Pause`:`Play`,action:Ut},{divider:!0},{label:M||P?`Focus viewport`:`Show panels`,action:xn}])},ln=e=>{e.preventDefault();let t=e.target.tagName;if(t===`INPUT`||t===`TEXTAREA`){let t=e.target;rn(e.clientX,e.clientY,[{label:`Cut`,shortcut:`Ctrl/⌘ X`,disabled:t.selectionStart===t.selectionEnd,action:()=>document.execCommand(`cut`)},{label:`Copy`,shortcut:`Ctrl/⌘ C`,disabled:t.selectionStart===t.selectionEnd,action:()=>document.execCommand(`copy`)},{label:`Paste`,shortcut:`Ctrl/⌘ V`,action:()=>document.execCommand(`paste`)}]);return}rn(e.clientX,e.clientY,[{label:`Undo`,disabled:at.length===0,action:Vt},{label:`Redo`,disabled:st.length===0,action:Ht}])},un=e=>b(t=>({...t,[e]:!t[e]})),dn=e=>w(t=>({...t,[e]:!t[e]})),fn=(e,t,n)=>{let r=Tt.current,i=G.current[r][e][t];if(O(!1),n<0){for(let n=r-1;n>=0;--n)if(G.current[n][e][t]!==i){h(n);return}}else for(let n=r+1;n<G.current.length;n+=1)if(G.current[n][e][t]!==i){h(n);return}},pn=(e,t)=>{y[e]||(Pt(),p(n=>n.map((n,r)=>r===Tt.current?{...n,[e]:{...n[e],[t]:0}}:n)))},mn=(e,t)=>{let n=G.current[Tt.current][e][t];xe({kind:`confirm`,title:`Make property constant`,message:`Set ${du[e].label} ${t.toUpperCase()} to ${pu(n)} on all ${G.current.length} steps? This removes its animation.`,confirmLabel:`Flatten`,onConfirm:()=>{Pt(),p(r=>r.map(r=>({...r,[e]:{...r[e],[t]:n}})))}})};function hn(){let e=[],t=n.trim()||`unnamed`;return e.push(`  ${t}:`),e.push(`    interval: ${i}`),e.push(`    loop: ${o}`),e.push(`    realistic-animations:`),e.push(`      enabled: ${c}`),e.push(`      frames: ${u}`),e.push(`    steps:`),f.forEach(t=>{lu.forEach((n,r)=>{let i=r===0?`      - `:`        `;e.push(`${i}${n}:`);let a=t[n];e.push(`          x: ${pu(a.x)}`),e.push(`          y: ${pu(a.y)}`),e.push(`          z: ${pu(a.z)}`)})}),e}let gn=(0,_.useMemo)(()=>hn().join(`
`),[n,i,o,c,u,f]),_n=(0,_.useMemo)(()=>`animations:\n${gn}\n`,[gn]);async function vn(){try{await navigator.clipboard.writeText(gn),j(`Copied to clipboard!`)}catch{try{let e=document.createElement(`textarea`);e.value=gn,document.body.appendChild(e),e.select(),document.execCommand(`copy`),document.body.removeChild(e),j(`Copied to clipboard!`)}catch{j(`Copy failed — select the text in the Preview tab.`)}}setTimeout(()=>j(``),2500)}function yn(){try{let e=new Blob([_n],{type:`text/yaml`}),t=URL.createObjectURL(e),n=document.createElement(`a`);n.href=t,n.download=`animations.yml`,document.body.appendChild(n),n.click(),document.body.removeChild(n),URL.revokeObjectURL(t),ne(`Downloaded animations.yml`)}catch{ne(`Download failed — copy the text instead.`)}setTimeout(()=>ne(``),2500)}function bn(e){_e(e),e===`animate`&&(O(!1),N(!0),re(!0))}function xn(){M||P?(N(!1),re(!1)):(N(!0),re(!0))}function Sn(e,t){R({id:e,fromZone:t})}function Cn(e){se(e)}function wn(e){se(t=>t===e?null:t)}function Tn(e){if(!L)return;let{id:t,fromZone:n}=L;if(n!==e){let r={left:ie.left.filter(e=>e!==t),right:ie.right.filter(e=>e!==t),bottom:ie.bottom.filter(e=>e!==t)};r[e]=[...r[e],t],ae(r),I(i=>{let a={...i,[e]:t};return i[n]===t&&(a[n]=r[n][0]),a}),N(!0),re(!0)}R(null),se(null)}function En(){R(null),se(null)}function Dn(){ae(_u),I(vu),N(!0),re(!0)}function On(e){return e===`pose`?(0,$.jsx)(Ou,{stepIndex:m,steps:f,pose:f[m],onChangeAxis:en,expanded:g,toggleExpanded:tn,lockedParts:y,hiddenParts:C,onDragStart:Pt,onFlattenAxis:mn,onJumpChange:fn,onResetAxis:pn,onValueContextMenu:sn,partOrder:x}):e===`settings`?(0,$.jsx)(ku,{animName:n,setAnimName:r,interval:i,setInterval:a,loop:o,setLoop:s,realisticEnabled:c,setRealisticEnabled:l,realisticFrames:u,setRealisticFrames:d,steps:f,onFieldFocus:Pt}):null}let kn={File:[{action:`import`,label:`Import animations.yml…`},{divider:!0},{action:`copy`,label:`Copy animation block`,shortcut:``},{action:`download`,label:`Download animations.yml`,shortcut:`Ctrl/⌘ S`},{divider:!0},{action:`new`,label:`New animation…`},{action:`backToProjects`,label:`Back to Project Selector…`},{action:`changeSavePreference`,label:`Change save preference…`}],Edit:[{action:`undo`,label:`Undo`,shortcut:`Ctrl/⌘ Z`,disabledKey:`canUndo`},{action:`redo`,label:`Redo`,shortcut:`Ctrl/⌘ ⇧Z`,disabledKey:`canRedo`},{divider:!0},{action:`resetPose`,label:`Reset this step’s pose`}],Step:[{action:`addStep`,label:`Add step`},{action:`duplicateStep`,label:`Duplicate step`,shortcut:`Ctrl/⌘ D`},{action:`deleteStep`,label:`Delete step`,disabledKey:`canDeleteStep`,shortcut:`Del`},{divider:!0},{action:`stepBack`,label:`Previous step`,shortcut:`←`},{action:`stepFwd`,label:`Next step`,shortcut:`→`}],Animation:[{action:`togglePlay`,label:D?`Pause`:`Play`,shortcut:`Space`},{action:`restart`,label:`Go to start`,shortcut:`Home`},{action:`jumpToEnd`,label:`Go to end`,shortcut:`End`},{divider:!0},{action:`toggleLoop`,label:o?`Disable loop`:`Enable loop`,shortcut:`L`},{action:`rename`,label:`Rename animation…`},{action:`setInterval`,label:`Set interval…`}],View:[{action:`zoomIn`,label:`Zoom in timeline`,shortcut:`+`},{action:`zoomOut`,label:`Zoom out timeline`,shortcut:`-`},{action:`resetCamera`,label:`Reset 3D camera`},{action:`toggleGrid`,label:ce?`Hide grid`:`Show grid`,shortcut:`G`},{divider:!0},{action:`toggleFocus`,label:M||P?`Focus viewport`:`Show panels`}],Window:[{action:`workspaceAnimate`,label:`Animate`},{action:`workspaceExport`,label:`Export`},{divider:!0},{action:`togglePoseInspector`,label:M?`Hide left panel`:`Show left panel`},{action:`toggleSettingsPanel`,label:P?`Hide right panel`:`Show right panel`},{divider:!0},{action:`resetLayout`,label:`Reset panel layout`}],Help:[{action:`openDocs`,label:`Plugin documentation`},{action:`shortcuts`,label:`Keyboard shortcuts`},{action:`about`,label:`About AS Animator`}]};function An(e){switch(e){case`import`:xe({kind:`import`,title:`Import animation`,onImport:e=>{Pt(),r(e.name),a(e.interval),s(e.loop),l(e.realisticEnabled),d(e.realisticFrames),p(e.steps),h(0)}});break;case`copy`:vn();break;case`download`:yn();break;case`new`:xe({kind:`confirm`,title:`New animation`,message:`This clears every step in the current animation. This can be undone with Edit → Undo.`,confirmLabel:`New animation`,onConfirm:()=>{Pt(),r(`unnamed`),a(10),s(!0),l(!1),d(4),p([mu()]),h(0)}});break;case`changeSavePreference`:xe({kind:`save`,title:`Change save preference`,message:`Choose which one Ctrl/⌘ S should do automatically — click one to select it:`,selectMode:!0,onExport:()=>Te(e=>e===`export`?null:`export`),onSaveBrowser:()=>Te(e=>e===`browser`?null:`browser`)});break;case`backToProjects`:xe({kind:`confirm`,title:`Back to Project Selector`,message:`This closes the current project. Anything not exported will be lost.`,confirmLabel:`Back to Projects`,onConfirm:()=>{Ce(!1),ot([]),ct([]),Pe(`choice`),Ie(``),Re(10),Be(!0),He(!1),We(4),Ke(``),Xe(``)}});break;case`undo`:Vt();break;case`redo`:Ht();break;case`resetPose`:Zt();break;case`addStep`:Jt();break;case`duplicateStep`:Yt(Tt.current);break;case`deleteStep`:J(Tt.current);break;case`stepBack`:Gt();break;case`stepFwd`:q();break;case`togglePlay`:Ut();break;case`restart`:K();break;case`jumpToEnd`:Wt();break;case`toggleLoop`:Kt();break;case`rename`:xe({kind:`prompt`,title:`Rename animation`,initial:n,confirmLabel:`Rename`,onSubmit:e=>{let t=e.trim().replace(/\s+/g,`_`);t&&(Pt(),r(t))}});break;case`setInterval`:xe({kind:`prompt`,title:`Set interval (ticks)`,initial:String(i),confirmLabel:`Set`,onSubmit:e=>{let t=parseInt(e,10);!Number.isNaN(t)&&t>0&&(Pt(),a(t))}});break;case`zoomIn`:A(e=>Math.min(2.5,pu(e+.2)));break;case`zoomOut`:A(e=>Math.max(.5,pu(e-.2)));break;case`toggleGrid`:le(e=>!e);break;case`resetCamera`:_t.current&&_t.current.resetView();break;case`toggleFocus`:xn();break;case`workspaceAnimate`:bn(`animate`);break;case`workspaceExport`:bn(`export`);break;case`togglePoseInspector`:N(e=>!e);break;case`toggleSettingsPanel`:re(e=>!e);break;case`resetLayout`:Dn();break;case`openDocs`:xe({kind:`info`,title:`Plugin documentation`,body:(0,$.jsxs)($.Fragment,{children:[`Full config reference for AdvancedArmorStands, including the animations.yml schema this editor writes to:`,(0,$.jsx)(`br`,{}),(0,$.jsx)(`a`,{href:`https://docs.advancedarmorstands.ir/`,target:`_blank`,rel:`noopener noreferrer`,children:`docs.advancedarmorstands.ir`})]})});break;case`shortcuts`:xe({kind:`info`,title:`Keyboard shortcuts`,body:(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Ctrl K`}),` / `,(0,$.jsx)(`code`,{children:`⌘ K`}),` — Open command search`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Space`}),` — Play / Pause`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`←`}),` / `,(0,$.jsx)(`code`,{children:`→`}),` — Previous / next step`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Delete`}),` / `,(0,$.jsx)(`code`,{children:`Backspace`}),` — Delete the selected step`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Delete`}),` after a marquee drag — deletes any fully-selected steps; partially-selected steps just get those parts reset to 0 instead`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Ctrl Z`}),` / `,(0,$.jsx)(`code`,{children:`⌘ Z`}),` — Undo`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Ctrl ⇧ Z`}),` / `,(0,$.jsx)(`code`,{children:`⌘ ⇧ Z`}),` — Redo`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Ctrl/⌘ D`}),` — Duplicate step`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Ctrl/⌘ S`}),` — Download animations.yml`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Home`}),` / `,(0,$.jsx)(`code`,{children:`End`}),` — Go to start / end`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`+`}),` / `,(0,$.jsx)(`code`,{children:`-`}),` — Zoom timeline in / out`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`L`}),` — Toggle loop`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`G`}),` — Toggle grid`]}),(0,$.jsxs)(`div`,{children:[(0,$.jsx)(`code`,{children:`Shift`}),` + drag a value — fine adjustment`]})]})});break;case`about`:xe({kind:`info`,title:`About AS Animator`,body:`A pose and timeline editor for AdvancedArmorStands. Build a pose per step, scrub the timeline, and export straight to animations.yml.`})}}(0,_.useEffect)(()=>{if(!ve)return;let e=e=>{e.target.closest(`.menu-wrap`)||ye(null)};return document.addEventListener(`pointerdown`,e),()=>document.removeEventListener(`pointerdown`,e)},[ve]),(0,_.useEffect)(()=>{function e(e){if((e.ctrlKey||e.metaKey)&&e.key.toLowerCase()===`k`){e.preventDefault(),Qe(e=>!e),nt(0);return}if(e.key===`Escape`&&Ze){Qe(!1);return}let t=document.activeElement&&document.activeElement.tagName;t!==`INPUT`&&t!==`TEXTAREA`&&(e.code===`Space`?(e.preventDefault(),Ut()):e.key===`ArrowLeft`?Gt():e.key===`ArrowRight`?q():(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()===`z`&&e.shiftKey?(e.preventDefault(),Ht()):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()===`z`?(e.preventDefault(),Vt()):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()===`d`?(e.preventDefault(),Yt(Tt.current)):(e.ctrlKey||e.metaKey)&&e.key.toLowerCase()===`s`?(e.preventDefault(),It()):e.key===`Delete`||e.key===`Backspace`?(e.preventDefault(),$t()):e.key===`Home`?K():e.key===`End`?Wt():e.key===`+`||e.key===`=`?A(e=>Math.min(2.5,pu(e+.2))):e.key===`-`||e.key===`_`?A(e=>Math.max(.5,pu(e-.2))):e.key.toLowerCase()===`l`?Kt():e.key.toLowerCase()===`g`&&le(e=>!e))}return window.addEventListener(`keydown`,e),()=>window.removeEventListener(`keydown`,e)},[at,st,f,T,Ze,we]);let jn=(0,_.useRef)(null),[Mn,Nn]=(0,_.useState)(!1),Pn=e=>{jn.current={startY:e.clientY,startH:me},Nn(!0),e.currentTarget.setPointerCapture(e.pointerId)},Fn=e=>{if(!jn.current)return;let t=jn.current.startY-e.clientY;he(Math.max(220,Math.min(640,jn.current.startH+t)))},In=()=>{jn.current=null,Nn(!1)},Ln=f.length>1?m/(f.length-1):0,Rn=m*i*50,zn=f.length>1?(f.length-1)*i*50:0,Bn=(0,_.useRef)(null),Vn=(0,_.useRef)(!1),Hn=e=>{let t=Bn.current.getBoundingClientRect(),n=Math.max(0,Math.min(1,(e-t.left)/t.width));O(!1),h(Math.round(n*(f.length-1)))},Un=e=>{Vn.current=!0,e.currentTarget.setPointerCapture(e.pointerId),Hn(e.clientX)},Wn=e=>{Vn.current&&Hn(e.clientX)},Gn=()=>{Vn.current=!1},Kn={canUndo:at.length>0,canRedo:st.length>0,canDeleteStep:f.length>1,canResetSavePref:we!==null},Y=[];Object.entries(kn).forEach(([e,t])=>{t.forEach(t=>{t.divider||t.disabledKey&&!Kn[t.disabledKey]||Y.push({id:`${e}-${t.action}`,label:t.label,group:e,run:()=>An(t.action)})})}),Y.push({id:`txt-name`,label:`Animation name: ${n}`,group:`Project`,run:()=>An(`rename`)},{id:`txt-interval`,label:`Interval: ${i} ticks`,group:`Project`,run:()=>An(`setInterval`)},{id:`txt-loop`,label:`Loop: ${o?`On`:`Off`}`,group:`Project`,run:Kt},{id:`txt-smooth`,label:`Smooth animation: ${c?`On`:`Off`}`,group:`Project`,run:()=>l(e=>!e)},{id:`txt-steps`,label:`${f.length} steps in this animation`,group:`Project`,run:()=>{}}),lu.forEach(e=>{Y.push({id:`txt-part-${e}`,label:`Edit ${du[e].label}`,group:`Pose`,run:()=>{v(t=>({...t,[e]:!0})),N(!0)}})});let qn=$e.trim().toLowerCase();function Jn(e){if(!/^[-+*/(). \d]+$/.test(e)||!/\d/.test(e)||!/[+\-*/]/.test(e))return null;try{let t=Function(`"use strict";return (${e})`)();return typeof t!=`number`||!Number.isFinite(t)?null:Math.round(t*1e6)/1e6}catch{return null}}let Yn=qn?Jn($e.trim()):null,Xn=Yn===null?null:{id:`math-result`,label:`${$e.trim()} = ${Yn}`,group:`Calculator`,isMath:!0,run:()=>{navigator.clipboard&&navigator.clipboard.writeText(String(Yn))}},Zn=(qn?Y.map(e=>{let t=e.label.toLowerCase(),n=0;return t===qn?n=100:t.startsWith(qn)?n=80:t.includes(qn)?n=50:qn.split(` `).every(e=>e&&t.includes(e))&&(n=30),{...e,score:n}}).filter(e=>e.score>0).sort((e,t)=>t.score-e.score):Y).slice(0,Xn?7:8);Xn&&Zn.unshift(Xn);let Qn=null;if(qn){let e=Y.filter(e=>!e.disabled&&e.label.toLowerCase().startsWith(qn));e.length===1&&e[0].label.toLowerCase()!==qn&&(Qn=e[0])}function $n(e){e.run(),Qe(!1),e.isMath||it(t=>[e.label,...t.filter(t=>t!==e.label)].slice(0,6)),et(``)}let er=qn?Zn.map(e=>({...e,isHistory:!1,run:()=>$n(e)})):[...rt.map(e=>({id:`h-${e}`,label:e,isHistory:!0,run:()=>et(e)})),...Zn.map(e=>({...e,isHistory:!1,run:()=>$n(e)}))];function tr(e){if(e.key===`Tab`&&Qn){e.preventDefault(),et(Qn.label);return}e.key===`ArrowDown`?(e.preventDefault(),nt(e=>Math.min(er.length-1,e+1))):e.key===`ArrowUp`?(e.preventDefault(),nt(e=>Math.max(0,e-1))):e.key===`Enter`?(e.preventDefault(),er[tt]&&er[tt].run()):e.key===`Escape`&&(qn&&Zn.length===0&&it(e=>[$e.trim(),...e.filter(e=>e!==$e.trim())].slice(0,6)),Qe(!1))}return e?ht?(0,$.jsxs)(`div`,{className:`aas-app`,onContextMenu:ln,children:[(0,$.jsx)(`style`,{children:Iu}),(0,$.jsx)(`div`,{className:`guard-screen`,children:(0,$.jsxs)(`div`,{className:`guard-box`,children:[(0,$.jsx)(`div`,{className:`guard-icon`,children:`🖥️`}),(0,$.jsx)(`div`,{className:`guard-title`,children:`Desktop only`}),(0,$.jsx)(`div`,{className:`guard-body`,children:`AS Animator needs a mouse, a keyboard and a real amount of screen space — phones and tablets aren't supported. Open this on a computer, or switch your browser to desktop mode if you're set on using a bigger tablet.`})]})})]}):gt?(0,$.jsxs)(`div`,{className:`aas-app`,onContextMenu:ln,children:[(0,$.jsx)(`style`,{children:Iu}),(0,$.jsx)(`div`,{className:`guard-screen`,children:(0,$.jsxs)(`div`,{className:`guard-box`,children:[(0,$.jsx)(`div`,{className:`guard-icon`,children:`↔️`}),(0,$.jsx)(`div`,{className:`guard-title`,children:`Screen too small`}),(0,$.jsx)(`div`,{className:`guard-body`,children:`This window is too small to fit the editor (needs at least ~980×560px). Widen the browser window, undock it, or turn your device back to a normal orientation to keep using it.`})]})})]}):Se?(0,$.jsxs)(`div`,{className:`aas-app`,onContextMenu:ln,children:[(0,$.jsx)(`style`,{children:Iu}),(0,$.jsx)(Nu,{menus:kn,openMenu:ve,setOpenMenu:ye,onAction:An,flags:Kn}),(0,$.jsxs)(`div`,{className:`toolbar`,children:[(0,$.jsxs)(`div`,{className:`workspace-tabs`,children:[(0,$.jsx)(`div`,{className:`workspace-tab${ge===`animate`?` active`:``}`,onClick:()=>bn(`animate`),children:`Animate`}),(0,$.jsx)(`div`,{className:`workspace-tab${ge===`export`?` active`:``}`,onClick:()=>bn(`export`),children:`Export`})]}),(0,$.jsxs)(`div`,{className:`toolbar-title`,children:[`AS Animator — `,n||`unnamed`,Oe!==null&&(0,$.jsx)(`span`,{className:`save-status${Oe===z()?``:` dirty`}`,children:Oe===z()?`Saved`:`Unsaved`})]}),(0,$.jsx)(`div`,{className:`toolbar-spacer`}),ge===`animate`&&(0,$.jsx)(`button`,{type:`button`,className:`icon-ghost-btn`,onClick:xn,title:M||P?`Focus viewport`:`Show panels`,children:M||P?(0,$.jsx)(Wl,{size:16}):(0,$.jsx)(Gl,{size:16})})]}),ge===`export`?(0,$.jsx)(Au,{animName:n,interval:i,loop:o,realisticEnabled:c,realisticFrames:u,steps:f,fullYaml:_n,copySnippet:vn,downloadYaml:yn,copyStatus:ee,downloadStatus:te,onSaveBrowser:B,saveBrowserStatus:Ae}):(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`body-row`,children:[M&&(0,$.jsx)(Lu,{zoneId:`left`,panelIds:ie.left,activeId:F.left,onActivate:(e,t)=>I(n=>({...n,[e]:t})),onDragStartTab:Sn,onDragOverZone:Cn,onDragLeaveZone:wn,onDropTab:Tn,onDragEndTab:En,isDropTarget:oe===`left`,isDraggingAnything:!!L,renderContent:On}),(0,$.jsxs)(`div`,{className:`viewport-panel`,children:[(0,$.jsxs)(`div`,{className:`viewport-wrap`,onContextMenu:cn,children:[(0,$.jsx)(Du,{ref:_t,initialShowGrid:ce,locked:ue}),(0,$.jsxs)(`div`,{className:`viewport-settings`,children:[(0,$.jsx)(`button`,{type:`button`,className:`viewport-settings-btn`,onClick:()=>pe(e=>!e),title:`Viewport settings`,children:(0,$.jsx)($l,{size:15})}),fe&&(0,$.jsx)(`div`,{className:`viewport-settings-menu`,children:(0,$.jsxs)(`button`,{type:`button`,className:`menu-dd-item`,onClick:()=>le(e=>!e),children:[(0,$.jsxs)(`span`,{children:[(0,$.jsx)(Vl,{size:13,style:{marginRight:6,verticalAlign:-2}}),`Grid`]}),(0,$.jsx)(`span`,{children:ce?`On`:`Off`})]})})]}),(0,$.jsx)(`div`,{className:`viewport-hint`,children:`drag to orbit · scroll to zoom`}),(0,$.jsx)(`button`,{type:`button`,className:`viewport-lock-btn`,onClick:()=>de(e=>!e),title:ue?`Unlock camera`:`Lock camera`,children:ue?(0,$.jsx)(Ul,{size:15}):(0,$.jsx)(Hl,{size:15})})]}),(0,$.jsxs)(`div`,{className:`scrub-strip${D?` playing`:``}`,ref:Bn,onPointerDown:Un,onPointerMove:Wn,onPointerUp:Gn,children:[(0,$.jsx)(`div`,{ref:kt,className:`scrub-fill`,style:{width:`${Ln*100}%`}}),(0,$.jsx)(`div`,{ref:At,className:`scrub-marker`,style:{left:`${Ln*100}%`}}),(0,$.jsxs)(`div`,{className:`scrub-step-readout`,children:[`STEP `,String(m+1).padStart(2,`0`),`/`,String(f.length).padStart(2,`0`),(0,$.jsxs)(`span`,{className:`sub`,children:[`tick `,m*i]})]}),(0,$.jsxs)(`div`,{className:`scrub-time`,children:[(0,$.jsx)(`span`,{ref:jt,children:Su(Rn)}),(0,$.jsxs)(`span`,{className:`scrub-time-total`,children:[` / `,Su(zn)]})]})]}),(0,$.jsxs)(`div`,{className:`transport-bar`,children:[(0,$.jsx)(`button`,{type:`button`,className:`transport-btn`,onClick:K,title:`Go to first step`,children:(0,$.jsx)(eu,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:`transport-btn`,onClick:Gt,title:`Previous step`,children:(0,$.jsx)(nu,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:`transport-btn play`,onClick:Ut,title:D?`Pause`:`Play`,children:D?(0,$.jsx)(ql,{size:18}):(0,$.jsx)(Jl,{size:18})}),(0,$.jsx)(`button`,{type:`button`,className:`transport-btn`,onClick:q,title:`Next step`,children:(0,$.jsx)(ru,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:`transport-btn`,onClick:Wt,title:`Go to last step`,children:(0,$.jsx)(tu,{size:16})}),(0,$.jsx)(`button`,{type:`button`,className:`transport-btn${o?` on`:``}`,onClick:Kt,title:`Toggle loop`,children:(0,$.jsx)(Xl,{size:16})})]})]}),P&&(0,$.jsx)(Lu,{zoneId:`right`,panelIds:ie.right,activeId:F.right,onActivate:(e,t)=>I(n=>({...n,[e]:t})),onDragStartTab:Sn,onDragOverZone:Cn,onDragLeaveZone:wn,onDropTab:Tn,onDragEndTab:En,isDropTarget:oe===`right`,isDraggingAnything:!!L,renderContent:On})]}),(0,$.jsx)(Lu,{zoneId:`bottom`,panelIds:ie.bottom,activeId:F.bottom,onActivate:(e,t)=>I(n=>({...n,[e]:t})),onDragStartTab:Sn,onDragOverZone:Cn,onDragLeaveZone:wn,onDropTab:Tn,onDragEndTab:En,isDropTarget:oe===`bottom`,isDraggingAnything:!!L,renderContent:On,horizontal:!0}),(0,$.jsx)(`div`,{className:`resize-handle${Mn?` active`:``}`,onPointerDown:Pn,onPointerMove:Fn,onPointerUp:In}),(0,$.jsx)(`div`,{style:{height:me,flexShrink:0,display:`flex`},children:(0,$.jsx)(Mu,{steps:f,selectedStep:m,setSelectedStep:e=>{O(!1),h(e)},interval:i,addStep:Jt,duplicateStep:Yt,deleteStep:J,zoom:k,setZoom:A,playheadRef:yt,lockedParts:y,hiddenParts:C,toggleLocked:un,toggleHidden:dn,isPlaying:D,onMoveStep:Qt,scrollAreaRef:vt,partOrder:x,setPartOrder:S,onDotContextMenu:an,onTimelineContextMenu:on,selectedDots:T,setSelectedDots:E})})]}),(0,$.jsx)(Pu,{modal:be,onClose:()=>xe(null),savePref:we}),(0,$.jsx)(Fu,{menu:lt,onClose:nn}),Ze&&(0,$.jsx)(`div`,{className:`palette-overlay`,onClick:()=>Qe(!1),children:(0,$.jsxs)(`div`,{className:`palette-box`,onClick:e=>e.stopPropagation(),children:[(0,$.jsxs)(`div`,{className:`palette-input-row`,children:[(0,$.jsxs)(`div`,{className:`palette-ghost`,children:[(0,$.jsx)(`span`,{className:`ghost-typed`,children:$e}),(0,$.jsx)(`span`,{className:`ghost-suffix`,children:Qn?Qn.label.slice($e.length):``})]}),(0,$.jsx)(`input`,{autoFocus:!0,className:`palette-input`,value:$e,onFocus:e=>e.target.select(),onChange:e=>{et(e.target.value),nt(0)},onKeyDown:tr,placeholder:`Search actions, commands…`}),Qn&&(0,$.jsx)(`span`,{className:`palette-tab-badge`,children:`Tab`})]}),(0,$.jsxs)(`div`,{className:`palette-results`,children:[!qn&&rt.length>0&&(0,$.jsx)(`div`,{className:`palette-section-label`,children:`Recent`}),er.length===0&&(0,$.jsx)(`div`,{className:`palette-empty`,children:`No matching commands`}),er.map((e,t)=>(0,$.jsxs)(_.Fragment,{children:[t===rt.length&&!qn&&rt.length>0&&(0,$.jsx)(`div`,{className:`palette-section-label`,children:`Suggestions`}),(0,$.jsxs)(`button`,{type:`button`,className:`palette-item${e.isHistory?` history`:``}${t===tt?` active`:``}`,onMouseEnter:()=>nt(t),onClick:()=>e.run(),children:[(0,$.jsx)(`span`,{children:e.label}),e.isHistory?(0,$.jsx)(Ll,{size:12,className:`palette-history-icon`}):(0,$.jsx)(`span`,{className:`palette-group`,children:e.group})]})]},e.id))]})]})})]}):(0,$.jsxs)(`div`,{className:`aas-app`,onContextMenu:ln,children:[(0,$.jsx)(`style`,{children:Iu}),(0,$.jsxs)(`div`,{className:`gate-screen`,children:[(0,$.jsxs)(`div`,{className:`gate-left`,children:[(0,$.jsx)(`div`,{className:`gate-title`,children:`AS Animator`}),(0,$.jsxs)(`div`,{className:`gate-sub`,children:[`Pose & timeline editor for AdvancedArmorStands. Build a pose per keyframe, scrub the timeline, export straight to `,(0,$.jsx)(`code`,{children:`animations.yml`}),`.`]})]}),(0,$.jsxs)(`div`,{className:`gate-right`,children:[H===`choice`&&(0,$.jsxs)(`div`,{className:`gate-card`,children:[(0,$.jsx)(`button`,{type:`button`,className:`gate-btn primary`,onClick:()=>Pe(`new`),children:`New Project`}),(0,$.jsx)(`button`,{type:`button`,className:`gate-btn`,onClick:()=>Pe(`import`),children:`Import Project`})]}),H===`new`&&(0,$.jsxs)(`div`,{className:`gate-card`,children:[(0,$.jsx)(`div`,{className:`gate-card-title`,children:`New Project`}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Name`}),(0,$.jsx)(`input`,{autoFocus:!0,className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,value:Fe,onChange:e=>Ie(e.target.value),placeholder:`unnamed`})]}),(0,$.jsxs)(`div`,{className:`gate-options-row`,children:[(0,$.jsxs)(`div`,{className:`gate-options-label`,children:[`Project options`,(0,$.jsx)(`button`,{type:`button`,className:`gate-reset-link`,onClick:Lt,children:`Reset`})]}),(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsx)(`span`,{children:`Interval (ticks)`}),(0,$.jsx)(`input`,{className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,type:`number`,min:`1`,value:Le,onChange:e=>Re(Math.max(1,parseInt(e.target.value,10)||1))})]}),(0,$.jsxs)(`label`,{className:`field checkbox-field`,children:[(0,$.jsx)(`span`,{children:`Smooth animation`}),(0,$.jsx)(`button`,{type:`button`,className:`tick-box${Ve?` on`:``}`,onClick:()=>He(e=>!e),children:Ve&&(0,$.jsx)(jl,{size:12})})]}),(0,$.jsxs)(`label`,{className:`field${Ve?``:` field-disabled`}`,children:[(0,$.jsx)(`span`,{children:`Interpolation frames`}),(0,$.jsx)(`input`,{className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,type:`number`,min:`1`,disabled:!Ve,value:Ue,onChange:e=>We(Math.max(1,parseInt(e.target.value,10)||1))})]}),(0,$.jsxs)(`label`,{className:`field checkbox-field`,children:[(0,$.jsx)(`span`,{children:`Loop`}),(0,$.jsx)(`button`,{type:`button`,className:`tick-box${ze?` on`:``}`,onClick:()=>Be(e=>!e),children:ze&&(0,$.jsx)(jl,{size:12})})]})]}),(0,$.jsxs)(`div`,{className:`gate-card-actions`,children:[(0,$.jsx)(`button`,{type:`button`,className:`gate-btn`,onClick:()=>Pe(`choice`),children:`Back`}),(0,$.jsx)(`button`,{type:`button`,className:`gate-btn primary`,onClick:Rt,children:`Create Project`})]})]}),H===`import`&&(0,$.jsxs)(`div`,{className:`gate-card`,children:[(0,$.jsx)(`div`,{className:`gate-card-title`,children:`Import Project`}),Ee&&(0,$.jsxs)($.Fragment,{children:[(0,$.jsxs)(`div`,{className:`gate-browser-save`,children:[(0,$.jsxs)(`div`,{className:`gate-browser-save-info`,children:[(0,$.jsx)(`strong`,{children:Ee.animName}),(0,$.jsxs)(`span`,{children:[Ee.steps.length,` steps`]})]}),(0,$.jsxs)(`div`,{className:`gate-browser-save-actions`,children:[(0,$.jsx)(`button`,{type:`button`,className:`gate-btn primary`,onClick:Ne,children:`Import from browser`}),(0,$.jsx)(`button`,{type:`button`,className:`gate-btn`,onClick:V,children:`Delete`})]})]}),(0,$.jsx)(`div`,{className:`gate-divider`,children:(0,$.jsx)(`span`,{children:`or`})})]}),(0,$.jsxs)(`div`,{className:`hint`,children:[`Paste your `,(0,$.jsx)(`code`,{children:`animations.yml`}),` (or just one animation block) below.`]}),(0,$.jsx)(`textarea`,{autoFocus:!0,className:`yaml-preview`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,style:{minHeight:160},value:Ge,onChange:e=>{Ke(e.target.value),Xe(``)},placeholder:`wave:
  interval: 10
  loop: true
  realistic-animations:
    enabled: false
  ...
  steps:
    - head:
        x: 0
        ...`}),zt.length>1&&(0,$.jsxs)(`label`,{className:`field`,children:[(0,$.jsxs)(`span`,{children:[`Found `,zt.length,` animations — import which one?`]}),(0,$.jsx)(`select`,{className:`text-input`,spellCheck:!1,autoCorrect:`off`,autoCapitalize:`off`,value:qe||zt[0],onChange:e=>Je(e.target.value),children:zt.map(e=>(0,$.jsx)(`option`,{value:e,children:e},e))})]}),Ye&&(0,$.jsx)(`div`,{className:`modal-error`,children:Ye}),(0,$.jsxs)(`div`,{className:`gate-card-actions`,children:[(0,$.jsx)(`button`,{type:`button`,className:`gate-btn`,onClick:()=>Pe(`choice`),children:`Back`}),(0,$.jsx)(`button`,{type:`button`,className:`gate-btn primary`,onClick:Bt,children:`Import`})]})]})]})]})]}):(0,$.jsxs)(`div`,{className:`aas-app`,onContextMenu:ln,children:[(0,$.jsx)(`style`,{children:Iu}),(0,$.jsx)(`div`,{className:`boot-screen`,children:(0,$.jsx)(`div`,{className:`apple-spinner`,children:Array.from({length:12}).map((e,t)=>(0,$.jsx)(`div`,{className:`apple-spinner-blade`,style:{transform:`rotate(${t*30}deg)`,animationDelay:`${-(12-t)/12}s`}},t))})})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,$.jsx)(_.StrictMode,{children:(0,$.jsx)(Ru,{})}));